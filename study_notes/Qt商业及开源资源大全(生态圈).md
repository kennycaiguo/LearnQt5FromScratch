...
https://github.com/qtproject/qt-solutions – 里面有属性网格qtpropertybrowser
...
[Qt编写网络调试助手（TCP客户端+TCP服务端+UDP服务端）终极版开源20180514](http://www.qtcn.org/bbs/read-htm-tid-65985-ds-1.html) – 跨平台的TCPUDPDbg，刘典武开源项目
...
## 5. [CTK](https://github.com/commontk/CTK)
...
[https://qwt.sourceforge.io/index.html](https://qwt.sourceforge.io/) – qwt强大的图表控件
...
skype，[virtualBox](https://www.virtualbox.org/)，[The Ipe extensible drawing editor](http://ipe.otfried.org/)

# 八. Qt Github精品项目

## 1. IDE

https://github.com/visualfc/liteide – go IDE，使用了Qt Creator的插件机制
...
https://github.com/tsujan/Kvantum A Linux SVG-based theme engine for Qt and KDE
...
https://github.com/rekols — [这些年用QT写的软件By:rekols](http://www.qtcn.org/bbs/u/159988)
...
https://github.com/QtDocumentCN/QtDocumentCN –中文翻译
...
https://github.com/mltframework/shotcut – 视频制作
...
https://github.com/OpenShot/openshot-qt OpenShot Video Editor是一款屡获殊荣的免费，开源Linux，Mac和Windows视频编辑器，致力于为世界提供高质量的视频编辑和动画解决方案。
...
https://github.com/nitroshare/nitroshare-desktop ++ https://nitroshare.net/ 局域网传输工具

https://github.com/IJHack/QtPass QtPass is a GUI for pass, the standard unix password manager密码管理

https://github.com/Archie3d/qpdf pdf阅读器

# 九. Qt sourceforge精品项目
...
https://sourceforge.net/projects/limereport/ ++ https://github.com/fralx/LimeReport Report generator for Qt【推荐】
...
https://sourceforge.net/projects/class-generator/ ++
...
- [Communi](https://communi.github.io/) - 跨平台 IRC 框架。我们已经有足够的 IRC 客户端了，但我想这也可以用于在您的应用程序中实现聊天功能（例如用于社区支持）。
- [Cutelyst](http://cutelyst.org/) - 从 Perl 的 Catalyst 框架中汲取一些想法的 Web 框架。
- [DiceParser](https://github.com/Rolisteam/DiceParser) - 基于其自身语法的骰子滚轮框架。
- [DOtherSide](https://github.com/filcuc/DOtherSide) - 在 C 中绑定 QML，主要设计为*其他*语言的 API以支持 QML。
- [Felgo](https://felgo.com/) - 严重依赖 QML 的跨平台游戏引擎和应用程序框架。拥有大量工具和资源，甚至可能值得拥有自己的清单。
- [glraw](https://github.com/cginternals/glraw) - 将图像从任何 Qt 支持的格式转换为 OpenGL 格式的纹理。用于加速图形应用程序中的纹理加载。
- [grantlee](https://github.com/steveire/grantlee) - 受 Django 启发的文本模板。
- [injeqt](https://github.com/vogel/injeqt) - Qt 的依赖注入。
- [KDE Frameworks](https://api.kde.org/frameworks) - 用于 KDE 的大量库，但其中许多也可以与常规 Qt 应用程序一起使用。在大多数情况下，跨平台。
- [Marble](https://marble.kde.org/) - 可以独立使用或嵌入其他应用程序的虚拟地球仪和地图。
- [qgexedit2](https://github.com/Simsys/qhexedit2) - 在您的应用程序中嵌入十六进制编辑器。
- [qml-material](https://github.com/papyros/qml-material) - 在 QML 中实现的材料设计。
- [QNodeView](https://github.com/gwihlidal/QNodeView) - 小部件，可让您在类似于 Unreal Engine、Substance Designer 或 PureData 提供的类型的图形中创建和编辑节点。
- [QSimpleUpdater](https://github.com/alex-spataru/QSimpleUpdater) - 让您的应用程序自行更新。
- [qt-maybe](https://github.com/robertknight/qt-maybe) - 类型理论的粉丝会喜欢这些总和和可选类型。
- [qt-mustache](https://github.com/robertknight/qt-mustache) - 渲染Mustache模板。
- [QtAV](http://www.qtav.org/) - 积极开发的多媒体框架。
- [Qtilities](https://jpnaude.github.io/Qtilities) - 一组强大的库，可为您的应用程序提供 GUI、日志记录、测试、配置和项目功能（以及其他功能）。
- [qtnotify](https://github.com/cybercatalyst/qtnotify) - 通知框架。
- [QtTerminalWidget](https://github.com/cybercatalyst/qtterminalwidget) - 使您的应用程序能够做**任何事情**。
- [QtVerbalExpressions](https://github.com/VerbalExpressions/QtVerbalExpressions) - 使用自然英语表达式创建正则表达式。VerbalExpressions项目的一部分，[它对多种语言](https://verbalexpressions.github.io/)执行相同的操作。
- [qtwebserver](https://github.com/cybercatalyst/qtwebserver) - 如果您出于某种原因需要在 Qt 中编写 Web 应用程序服务器，这将对您有所帮助。
- [QtXlsx](http://qtxlsx.debao.me/) - 以 Microsoft Excel 格式读取和写入电子表格。
- [Qwt](http://qwt.sourceforge.net/)- 专为科学和技术应用程序设计的 Qt 小部件。
- [verdigris](https://github.com/woboq/verdigris) -*无需*使用`moc`.

# 十二. 软件库

- [inqlude](https://inqlude.org/) - 最著名的以 Qt 为中心的库集合，也有一个包管理器。
- [QtPods](https://github.com/qt-pods/qt-pods) - 另一个以 Qt 为中心的包管理器。如果您想在不使用 QtPods 的情况下查看产品，可以[在此处](https://github.com/qt-pods/qt-pods-master/blob/master/pods.json)获得完整列表，并且可以通过提交拉取请求来添加。
- [Linux-Apps.com](https://www.linux-apps.com/) - 尽管名称如此，Linux-Apps.com 为最终用户和开发人员聚合了各种基于 Qt 的工具和库。
- [Stephan Binner 的 Ubuntu PPA](https://launchpad.net/~beineri) - 对安装包管理器之外的任何东西犹豫不决的 Ubuntu 用户可以从这些存储库中获取任何最新版本的 Qt。添加它们的说明可以在其中找到。

# 十三. Qt Git Client GUI
